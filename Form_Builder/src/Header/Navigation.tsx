...
export default function Navigation({ links }) {
  const [activeLink, setActiveLink] = useState(links[0]?.name || "Home");
  const [isMenuOpen, setIsMenuOpen] = useState(false);

  return (
    <div>
      <nav className="bg-white border-gray-200 dark:bg-gray-900 shadow-inner shadow-pink-500">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2 rounded-md">
          <a
            href="/"
